 ...
 * 
 * Version: 
 *     $Id: Account.java,v 1.1 2003/05/28 19:00:15 cs3 Exp csx $
 * 
 * Revisions: 
 *     $Log: Account.java,v $
...
public class Account implements Serializable {
     ...
     *
     * @param    myId         the account "number".
     * @param    myBalance    initial account balance in dollars.
     */

    public Account( String myId, int myBalance ) {
	id = myId;
	balance = myBalance;
    }
