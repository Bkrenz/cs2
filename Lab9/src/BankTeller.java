 ...
 * 
 * Version: 
 *     $Id: BankTeller.java,v 1.1 2003/05/28 19:00:15 cs3 Exp csx $
 * 
 * Revisions: 
 *     $Log: BankTeller.java,v $
...
public class BankTeller {
     ...
     * @param    theBank    the bank this teller works for.
     *
     */

    public BankTeller( int port, Bank theBank ) {
        bank = theBank;
    ...
    public void process() {
        ...
        // Forever (computers do not get breaks!!)
